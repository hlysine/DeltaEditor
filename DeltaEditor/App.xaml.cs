...
namespace DeltaEditor
{
    ...
    public partial class App : Application
    {
        public App()
        {
            ...
            try
            {
                using (var mgr = UpdateManager.GitHubUpdateManager("https://github.com/Profound-Education-Centre/DeltaEditor").Result)
                {
        ...
        {
            return ex != null && ex.Source == "DeltaEditor" && ex is FileNotFoundException && ex.Message.Contains(".dll");
        }
