using DeltaEditor.Config;
using DeltaEditor.Consts;
using DeltaEditor.DataSources;
using DeltaEditor.Helpers;
using DeltaEditor.Logging;
using DeltaEditor.Models;
using DeltaEditor.Models.Validation;
using DeltaEditor.Update;
using DeltaEditor.Views;
...
namespace DeltaEditor.ViewModels
{
    ...
    class MainViewModel : NotifyPropertyChanged, IDropTarget
    {
        ...
        public ICommand OpenHelpCommand => openHelpCommand ??= new RelayCommand(
                    ...
                    (param) =>
                    {
                        Process.Start("https://github.com/Profound-Education-Centre/DeltaEditor/wiki");
                    },
                    // can execute
                    (param) => { return true; }
                );
